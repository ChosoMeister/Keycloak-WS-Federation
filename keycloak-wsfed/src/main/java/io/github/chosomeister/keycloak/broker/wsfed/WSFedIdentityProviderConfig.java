...
public class WSFedIdentityProviderConfig extends IdentityProviderModel {
    ...
    public boolean isValidateSignature() {
        // Secure by default. Existing configurations can explicitly opt out,
        // but a missing value must never silently disable assertion validation.
        return !"false".equalsIgnoreCase(getConfig().get("validateSignature"));
    }
