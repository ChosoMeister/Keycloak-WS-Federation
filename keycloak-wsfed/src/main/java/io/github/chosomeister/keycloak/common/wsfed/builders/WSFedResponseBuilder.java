...
public class WSFedResponseBuilder {
    ...
    public WSFedResponseBuilder setMethod(String method) {
        if (!HttpMethod.GET.equals(method) && !HttpMethod.POST.equals(method)) {
            throw new IllegalArgumentException("WS-Federation response method must be GET or POST");
        }
        this.method = method;
        return this;
    }
    ...
    protected String buildHtml(String destination, String action, String result, String realm, String context, String username) {
        ...
        builder.append("<HTML>")
            ...
            .append("<FORM METHOD=\"").append(method).append("\" ACTION=\"")
            .append(escapeAttribute(destination)).append("\">");
        ...
        String[][] params = new String[][] {
            ...
            { WSFedConstants.WSFED_RESULT, result },
        ...
        Stream.of(params)
            ...
            .forEach(p -> builder.append("<INPUT TYPE=\"HIDDEN\" NAME=\"").append(p[0])
                    .append("\" VALUE=\"").append(escapeAttribute(p[1])).append("\" />"));
