...
package io.github.chosomeister.keycloak.common.wsfed.utils;
...
public class WSFedValidator {
    ...
    public Response basicChecks(String wsfedAction, UriInfo uriInfo,
        ...
        try {
            ...
            return ErrorPage.error(session, null, Response.Status.BAD_REQUEST, Messages.UNEXPECTED_ERROR_HANDLING_REQUEST);
        }
        return null;
    }
}
